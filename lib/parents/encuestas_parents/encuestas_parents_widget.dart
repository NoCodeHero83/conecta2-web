...
import 'encuestas_parents_model.dart';
export 'encuestas_parents_model.dart';

class EncuestasParentsWidget extends StatefulWidget {
  const EncuestasParentsWidget({super.key});

  static String routeName = 'EncuestasParents';
  static String routePath = '/encuestasParents';

  @override
  State<EncuestasParentsWidget> createState() => _EncuestasParentsWidgetState();
}

class _EncuestasParentsWidgetState extends State<EncuestasParentsWidget> {
  late EncuestasParentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EncuestasParentsModel());
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'Responde estas encuentas desarrolladas por nuestros especialistas',
