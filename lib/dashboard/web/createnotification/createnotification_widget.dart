...
import 'createnotification_model.dart';
export 'createnotification_model.dart';

part 'createnotification_form.dart';
part 'createnotification_sidebar.dart';
...
class _CreatenotificationWidgetState extends State<CreatenotificationWidget> {
  late CreatenotificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatenotificationModel());
