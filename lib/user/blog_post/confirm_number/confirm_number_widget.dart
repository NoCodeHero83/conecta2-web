...
import 'confirm_number_model.dart';
export 'confirm_number_model.dart';

class ConfirmNumberWidget extends StatefulWidget {
  const ConfirmNumberWidget({super.key});

  static String routeName = 'confirmNumber';
  static String routePath = '/confirmNumber';
...
class _ConfirmNumberWidgetState extends State<ConfirmNumberWidget> {
  late ConfirmNumberModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmNumberModel());
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Hemos enviado un código de verificación a tu número *** *** 324. Digitalo para poder iniciar sesión',
                                        style: FlutterFlowTheme.of(context)
                                            .labelSmall
                                            .override(
