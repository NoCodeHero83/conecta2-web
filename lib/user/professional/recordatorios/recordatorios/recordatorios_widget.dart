                      ...
                      children: [
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 40.0),
                                  child: Text(
                                    'En esta sección podrás ver tus recordatorios configurados.',
                          ...
                          builder: (context) {
                            if (_model.simpleSearchResults.isNotEmpty) {
                                    ...
                                    return ListView.separated(
                                      ...
                                      itemBuilder: (context, listIndex) {
                                        ...
                                        return InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed(
                                              RecordatoriosOpenWidget.routeName,
                                              queryParameters: {
                                                'recordatorID': serializeParam(
                                                  listItem.reference,
                              ...
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 24.0, 0.0, 0.0),
                                child: StreamBuilder<List<RecordatorRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<RecordatorRecord>
                                        listViewRecordatorRecordList =
                                        snapshot.data!;
                                    ...
                                    return ListView.separated(
                                      ...
                                      scrollDirection: Axis.vertical,
                                      itemCount:
                                          listViewRecordatorRecordList.length,
                                      separatorBuilder: (_, __) =>
                                          SizedBox(height: 8.0),
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewRecordatorRecord =
                                            listViewRecordatorRecordList[
                                                listViewIndex];
                                        return InkWell(
                                          splashColor: Colors.transparent,
                        ...
                        wrapWithModel(
                          ...
                          child: RegistartionButtonWidget(
                            ...
                            btnAction: () async {
                              context.pushNamed(
                                RecordatoriosAddWidget.routeName,
