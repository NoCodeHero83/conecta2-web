...
import 'enc_tam_respuesta_model.dart';
export 'enc_tam_respuesta_model.dart';

class EncTamRespuestaWidget extends StatefulWidget {
  const EncTamRespuestaWidget({
    super.key,
  ...
  static String routeName = 'EncTamRespuesta';
  static String routePath = '/encTamRespuesta';

  @override
  State<EncTamRespuestaWidget> createState() => _EncTamRespuestaWidgetState();
}

class _EncTamRespuestaWidgetState extends State<EncTamRespuestaWidget> {
  late EncTamRespuestaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EncTamRespuestaModel());
                              ...
                              return Column(
                                ...
                                children: List.generate(preguntas1.length,
                                  ...
                                  return EncuestaRespuesta2Widget(
                                    key: Key(
                                        'Keyeuh_${preguntas1Index}_of_${preguntas1.length}'),
