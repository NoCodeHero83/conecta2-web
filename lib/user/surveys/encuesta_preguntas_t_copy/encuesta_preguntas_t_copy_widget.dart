...
import 'encuesta_preguntas_t_copy_model.dart';
export 'encuesta_preguntas_t_copy_model.dart';

class EncuestaPreguntasTCopyWidget extends StatefulWidget {
  const EncuestaPreguntasTCopyWidget({
    super.key,
  ...
  @override
  State<EncuestaPreguntasTCopyWidget> createState() =>
      _EncuestaPreguntasTCopyWidgetState();
}

class _EncuestaPreguntasTCopyWidgetState
    extends State<EncuestaPreguntasTCopyWidget> {
  late EncuestaPreguntasTCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EncuestaPreguntasTCopyModel());
