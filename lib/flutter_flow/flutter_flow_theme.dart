...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFBE5A1);
  late Color secondary = const Color(0xFFF6BD33);
  late Color tertiary = const Color(0xFFB02E2D);
  late Color alternate = const Color(0xFFF6F6F6);
  late Color primaryText = const Color(0xFF18181E);
  late Color secondaryText = const Color(0xFF1F2129);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF6F6F6);
  late Color accent1 = const Color(0xFF6D98D8);
  late Color accent2 = const Color(0xFF1852BA);
  late Color accent3 = const Color(0xFF848A95);
  late Color accent4 = const Color(0xFFA47FFD);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color menuWeb = const Color(0xFF16407F);
  late Color web2 = const Color(0xFFF5F5F5);
  late Color lightBlueForMobile = const Color(0xFF008DCD);
}
