      ...
      children: [
        ...
        FutureBuilder<List<EmocionesRegistroRecord>>(
          ...
          builder: (context, snapshot) {
            ...
            return FutureBuilder<List<RemindersRecord>>(
              ...
              builder: (context, remindersSnapshot) {
                final remindersList = remindersSnapshot.data ?? [];
                      ...
                      builder: (context) {
                        ...
                        return GridView.builder(
                          ...
                          itemBuilder: (context, calendarIndex) {
                            ...
                            final dayDateStr = dateTimeFormat(
                              "d/M/y",
                              calendarItem.calendarDate,
                              locale:
                                  FFLocalizations.of(context).languageCode,
                            );
                            final dayReminders = remindersList
                                .where((r) =>
                                    r.hasDueDate() &&
                                    dateTimeFormat(
                                          "d/M/y",
                            ...
                            return InkWell(
                              ...
                              onTap: () async {
                                ...
                                // Query reminders for this specific day.
                                _model.dayReminders =
                                    ...
                                    isEqualTo: currentUserReference,
                                        ...
                                        .where((r) =>
                                            ...
                                            dateTimeFormat(
                                                ...
                                                dayDateStr)
                                        .toList());
                                if ((_model.leerreaccion != null) == true ||
                                    (_model.dayReminders?.isNotEmpty ??
                                        false)) {
                                  context.pushNamed(
                                    CalendarOpenWidget.routeName,
                                    queryParameters: {
                                    ...
                                    extra: <String, dynamic>{
                                      'emocion': _model.leerreaccion,
                                      'reminders': _model.dayReminders,
